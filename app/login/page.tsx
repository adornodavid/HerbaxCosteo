        ...
        <div className="flex items-center justify-center w-full max-w-6xl">
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-blue-50/30 to-slate-100/40 rounded-3xl shadow-2xl"></div>
              ...
              <div className="relative bg-[#E7F0F9]/90 rounded-xs shadow-2xl p-8">
                {/* Header */}
