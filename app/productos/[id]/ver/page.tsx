                    ...
                    <div className="space-y-6">
                      {producto.formulasxproducto.map((formulaRel, index) => (
                        <div key={index} className="border rounded-lg p-4 space-y-4">
                          <div 
                            className="flex items-center gap-4 border-b pb-3 cursor-pointer hover:bg-blue-50 transition-colors rounded-t-lg p-2"
                            onClick={() => {
                              console.log("[v0] Formula clicked:", formulaRel.formulas)
                              if (formulaRel.formulas?.id) {
                                console.log("[v0] Navigating to formula:", formulaRel.formulas.id)
                                router.push(`/formulas/${formulaRel.formulas.id}/ver`)
                              } else {
                                console.log("[v0] No formula id found")
                              }
                            }}
                          >
                            {/* Icon on left */}
