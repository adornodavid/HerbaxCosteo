...
================================================== */
export default function VerZonaPage() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <PageTitlePlusNew
        Titulo="Información de zona"
        Subtitulo="Información completa de la zona"
        Visible={false}
        BotonTexto={null}
        Ruta={null}
      />

      {/* Card with zona information */}
        ...
        {esAdminDOs && (
          <>
            ...
            <Button
              ...
              onClick={() => router.push(`/zonas/${zonaId}/eliminar`)}
            >
