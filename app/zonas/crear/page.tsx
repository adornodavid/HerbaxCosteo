...
export default function CrearZonaPage() {
  ...
  const ejecutarRegistro = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/zonas/${result.data}/editar`)
      } else {
        setModalError({
          Titulo: "Error al crear zona",
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <PageTitlePlusNew
        Titulo="Creación de nueva zona"
        Subtitulo="Formulario para registrar una nueva zona"
        Visible={false}
        BotonTexto={null}
        Ruta={null}
      />
      ...
      <Card>
        <CardContent className="pt-6">
          <form id="frmZona" onSubmit={ejecutarRegistro} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="txtNombre">
                  <span className="text-red-500">*</span> Nombre
                </Label>
                <Input id="txtNombre" name="nombre" type="text" placeholder="Ingrese el nombre de la zona" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="txtClave" name="clave" type="text" placeholder="Ingrese la clave de la zona" />
              </div>
            </div>
