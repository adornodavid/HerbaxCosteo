  ...
  return (
    <div className="fixed left-0 top-0 w-[100px] h-screen bg-white border-r border-gray-200 flex flex-col items-center py-4 z-40">
      ...
      <Link
        ...
        title="Fórmulas"
      >
        <Icons.FlaskRound className="w-6 h-6 text-gray-700 mb-1" />
        <span className="text-xs text-gray-600">Fórmulas</span>
      </Link>
      ...
      <Link
        ...
        title="Cotizador"
      >
        <Icons.FileText className="w-6 h-6 text-gray-700 mb-1" />
        <span className="text-xs text-gray-600">Cotizador</span>
      </Link>
