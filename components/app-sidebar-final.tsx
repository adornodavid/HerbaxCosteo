...
export function AppSidebar() {
  ...
  // Inicializar/Re-inicializar Preline UI cuando el pathname cambia
  useEffect(() => {
    if (typeof window !== 'undefined' && window.HSStaticMethods) {
      window.HSStaticMethods.autoInit();
      console.log("Preline UI initialized or re-initialized due to pathname change.");
    } else {
      console.log("HSStaticMethods no disponible, esperando...");
    }
  }, [pathname]); // Dependencia en pathname para re-inicializar en cada navegación
